...
class UjianController extends Controller
{
    ...
    public function jawabSoal(Request $request)
    {
        ...
        if ($soal->kunci == $validatedData['jawaban']) {
            ...
            // $ujianSoalList->save(); // berhasil update jawaban
